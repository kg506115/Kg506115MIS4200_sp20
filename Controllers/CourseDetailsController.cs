...
namespace Kg506115MIS4200_sp20.Controllers
{
    public class CourseDetailsController : Controller
    {
        ...
        {
            ViewBag.courseID = new SelectList(db.Courses, "courseID", "courseAbbreviation");
        ...
        public ActionResult Create([Bind(Include = "courseDetailsID,semesterDate,courseID,studentID")] CourseDetails courseDetails)
        {
